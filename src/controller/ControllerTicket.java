...
public class ControllerTicket extends ControllerWindow {
		...
		public void mouseClicked(MouseEvent evnt) {
			if (evnt.getClickCount() == 1) {
				...
				controllerTicket._ticketGui.getBtnPeople()
						.setText("Se selecion� a " + controllerTicket.dtoPeopleSelect.getName());
			}
		...
		public void mouseClicked(MouseEvent evnt) {
			if (evnt.getClickCount() == 1) {
				...
				controllerTicket._ticketGui.getBtnCar()
						.setText("Se selecion� a " + controllerTicket.dtoCarSelect.getPlaca());
			}
		}// cierre m�todo mouseClicked
	...
	private class MauseClickedOnTableTicke extends MouseAdapter {
		...
		public void mouseClicked(MouseEvent evnt) {
			if (evnt.getClickCount() == 1) {
				...
				controllerTicket.actualTicketSelect = contador;
				controllerTicket._ticketGui.getBtnCar()
						.setText("Se selecion� a " + _listTicket.getOne(contador).getPlacaAuto());

				controllerTicket._ticketGui.getBtnPeople()
						.setText("Se selecion� a " + _listTicket.getOne(contador).getEmailAuto());
	...
	private void searchReport() {
		...
		executor.execute(() -> {
			...
			String index = (String) JOptionPane.showInputDialog(new JFrame(), "Qu� reporte deseas ver?", "Formato de Reporte",
