...
/**
 * Archivo: ControllerPeople.java contiene la definici�n de la clase
...
//declaraci�n de atributos
	...
	/**
	 * Constructor ControllerPeople con par�metro
	 * 
	...
	/**
	 * M�todo reloadDataList Obtiene los datos de la lista.
	 * 
	...
	}// cierre m�todo reloadDataList

	/**
	 * M�todo saveRegistry Guarda o modifica los datos de People.
	 * 
	 * @return retorna un valor booleano
	 */
	@Override
	...
	/**
	 * M�todo filter Filtrar los datos de la lista People.
	 * 
	...
	/**
	 * M�todo updateRegistry Actualiza un valor de tipo People.
	 * 
	...
	public boolean updateRegistry() {
		...
		return false;
	}// cierre m�tod updateRegistry

	/**
	 * M�todo deleteRegistry Elimina un registro de la lista People.
	 * 
	 * @return retorna un valor booleano.
	 */
	@Override
	...
	/**
	 * M�todo getDataOfView Obtiene los datos de la vista.
	 * 
	 * @return retorna un valor booleano.
	 */
	@Override
	...
	/**
	 * M�todo validateFieldText Valida el texto de los campos
	 * 
	...
	/**
	 * M�todo setDataOfView Envia los datos a la vista.
	 * 
	 * @return retorna un valor booleano.
	 */
	@Override
	...
	/**
	 * M�todo keyReleased Evento del teclado
	 */
	@Override
	...
	/**
	 * Cierre m�todo searchReport Carga el reporte "simple o avanzado".
	 */
	...
	/**
	 * M�todo addScrollTable Agrega un scroll a la tabla.
	 */
	...
	}// cierre m�todo addScrollTable

	/**
	 * M�todo loadNextCars Carga los datos del carro que pertenece a People
	 */
...
//Inner Class Event to view
	...
	/**
	 * Archivo: ControllerPeople.java que contiene la definici�n de la clase
