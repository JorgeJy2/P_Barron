 ...
 * 
 *          {@link DtoCar} automovil que se ha estacionado. {@link DtoPeople}
 *          persona que ha estacionado el automovil.
 * 
 *
 */
public class DtoTicket extends Observable {
	...
	public DtoTicket() {
		this.id = 1;
		/*
		 * this.auto = new DtoCar(); this.people = new DtoPeople();
		 */
		idAuto = 90;
		idPesona = 2;
	 ...
	 * @param idAuto       valor de tipo entero
	 * @param idPersona    valor de tipo entero
	 * @param fechaEntrada valor de tipo String
	 * @param fechaSalida  valor de tipo String
	 * @param total_pago   valor de tipo double
	 * @param estatus      valor de tipo String
	 */
	public DtoTicket(int id, int idAuto, int idPersona, String fechaEntrada, String fechaSalida, double total_pago,
			String estatus) {
		super();
		this.id = id;
		this.idAuto = idAuto;
	...
	/*
	 * public DtoCar getAuto() { return auto; }
	 * 
	 * public void setAuto(DtoCar auto) { this.auto = auto; this.notifyIObservers();
	 * }
	 * 
	 * public DtoPeople getPeople() { return people; }
	 * 
	 * public void setPeople(DtoPeople people) { this.people = people;
	 * this.notifyIObservers(); }
	 */
