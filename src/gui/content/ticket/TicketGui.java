...
public class TicketGui extends JPanel implements IObserver {
	...
	// private static final String[] DATE_PEOPLE = { "231ggg@gmail.com",
	// "gahgg@gmail.com", "gkit@gmail.com"};
	...
	private void createGui() {
		...
		lbLoseTicket = new JLabel(TEXT_LOSE_TICKET, JLabel.RIGHT);
		lbLoseTicket.setFont(ResourcesGui.FONT.getFontText());
